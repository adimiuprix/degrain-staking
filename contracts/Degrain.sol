...
contract Degrain is Context, Ownable, IERC20, ERC20Detailed {
    ...
    address payable public marketingaddress =
        payable(0x78282540167f21A17d80248721261DBd0dD5e8da);
    ...
    function setSellFee(
        uint256 _onSellEthBurndFee,
        uint256 _onSellliuidityFee,
        ...
        onSelltotalFees = SELLmarketingFee.add(SELLburnFee).add(
            SELLliquidityFee
        );
    ...
    function setBuyFee(
        uint256 _onBuyBurndFee,
        uint256 _onBuyliuidityFee,
