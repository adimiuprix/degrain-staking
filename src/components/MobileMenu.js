    ...
    { 'block animate-slideIn': isOpen, 'hidden ': !isOpen })}>
      ...
      <div className="">
        <ul className="flex flex-col items-center justify-between w-full space-y-11">
          ...
          {/* <li className="">
            <a className="px-6 py-3 truncate bg-white text-black uppercase font-medium transition ease-in-out duration-300 hover:border-[#b28760] hover:bg-[#b28760] hover:text-white" href="/">BUY CRNO</a>
          </li> */}
          <li className="">
            {account ? (
              <button
                className="py-2 px-6 ml-4 bg-white text-black truncate uppercase font-medium group transition ease-in-out duration-300 hover:border-[#b28760] hover:bg-[#b28760] hover:text-white flex items-center justify-center space-x-2"
